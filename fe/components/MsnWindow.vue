<template>
    <div v-if="visible" class="absolute border border-gray-700 bg-gray-100 w-[60vw] h-[70vh] shadow-xl z-50" :style="{ top: top + 'px', left: left + 'px' }">
      <div class="flex items-center justify-between bg-[#000080] text-white px-2 py-1 cursor-move" @mousedown="startDrag">
