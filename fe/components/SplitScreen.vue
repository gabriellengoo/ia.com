...
<div class="flash-layer">
  <div v-for="(img, index) in flashImages" :key="index"
       class="flash-image"
      >
    <img :src="img.src" />
  </div>
...
<h1 class="tapmes fixed bottom-10 text-center w-full text-sm sm:text-lg text-white z-50 pointer-events-none animate-fade-in">The Internet Arcitect</h1>
